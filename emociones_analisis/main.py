...
emotions=open('D:\David\Python\Robot\emociones_analisis\emotions.txt',encoding='utf-8').read()
...
abbreviations=open("D:\\David\\Python\\Robot\\emociones_analisis\\abbreviations.txt",encoding='utf-8').read()
...
sarcastic_emotion=[]
opp_emotion=[]
text1 = open("D:\\David\\Python\\Robot\\emociones_analisis\\sarcastic_emotions.txt", encoding="utf-8-sig").read()
text2 =text1.split('\n')
for word in text2:
    if i==0:
        i=1
...
for line in sentences:
    ...
    if senti_half1['compound'] > senti_half2['compound'] and senti_half2['compound'] < 0 and senti_half1['compound']>0:
...
print( emotion_count_stem.values())
print( emotion_count_stem.keys())